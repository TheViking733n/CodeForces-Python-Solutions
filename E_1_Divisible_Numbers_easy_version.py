...
def main():
    ...
    for _ in range(TestCases):
        ...
        found = False
        den = a * b
        for f1 in range(a + 1, c + 1):
            g = gcd(f1, den)
            left = den // g
            st = ((b + left - 1) // left) * left
            if st == b:
                st += left
            if st <= d:
                print(f1, st)
        ...
        #     g = gcd(y, i)
        #     den = y // g
        #     # now we have to find a number divisible by den in (b, d]
        #     if den <= d:
        #         v = d - d % den
        #         if v > b:
        #             print(i, v)
        ...
        #     cur *= i
        #     other = y // cur
        #     v1, v2 = sorted([cur, other])
        #     if a < v1 <= c and b < v2 <= d:
        #         print(v1, v2)
        #         done = True
        #         break

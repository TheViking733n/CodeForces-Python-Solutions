...
def main():
    ...
    for _ in range(TestCases):
        ...
        while arr[0][0] != arr[-1][0]:
            ...
            arr[-1][0] = (arr[-1][0] + arr[0][0] - 1) // arr[0][0]
            arr.sort()
        ...
        #         mn = min(mn, (minimize((arr[i],i), (arr[j], j)), i, j))
        ...
        # ans = []
        # m, i, j = mn
        # minimize((arr[i],i), (arr[j], j), ans)
        # arr[i] = arr[j] = m
        # for k in range(n):
        #     x = minimize((arr[k], k), (arr[i], i), ans)
            # print(x, end=' ~ ')
        # print()

...
def main():
    ...
    for _ in range(TestCases):
        ...
        ans = 1; prev = arr[0]; other = {0}
        for i in range(1, n):
            cur = arr[i]
            # print(prev, other, ans)
            if cur == prev and cur in other and len(other) == 1:
                prev = cur
                continue
            ans += 1
            if cur == prev:
        ...
        # dp1, dp2 = [0, 0, 0], [0, 0, 0]
        # for i in arr:
        #     dp1, dp2 = max([dp1[0] + int(i != dp1[1]), i, dp1[2]], [dp2[0] + int(i != dp2[1]), i, dp2[2]]), max([dp1[0] + int(i != dp1[2]), dp1[1], i], [dp2[0] + int(i != dp2[2]), dp2[1], i])

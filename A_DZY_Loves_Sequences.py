...
def main():
    ...
    for _ in range(TestCases):
        ...
        for i in range(n-1):
            v1, v2 = a2[i][-1], a2[i+1][0]
            a2[i][-1] = v2 - 1
            if check(a2[i], a2[i+1]):
                ans = max(ans, len(a2[i]) + len(a2[i+1]))
                a2[i][-1], a2[i+1][0] = v1, v2
                continue
            ...
            a2[i][-1], a2[i+1][0] = v1, v2
            ans = max([ans, len(a2[i]) + 1, len(a2[i+1]) + 1])
            # if len(a2[i]) >= 2:
            #     v1, v2, v3 = a2[i][-2], a2[i][-1], a2[i+1][0]
            #     if check(v1, v2, v3):
            #         ans = max(ans, len(a2[i]) + len(a2[i+1]))
            #         continue
            # if len(a2[i+1]) >= 2:
            #     v1, v2, v3 = a2[i][-1], a2[i+1][0], a2[i+1][1]
            #     if check(v1, v2, v3):
            #         ans = max(ans, len(a2[i]) + len(a2[i+1]))
            #         continue
        print(ans)

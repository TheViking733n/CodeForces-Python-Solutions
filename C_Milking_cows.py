...
def main():
    ...
    for _ in range(TestCases):
        ...
        # left = [i for i in range(n) if arr[i] == 0]
        # right = [i for i in range(n) if arr[i] == 1]
        # left.reverse()

        # rcnt = SegmentTree([i for i in arr])
        # lcnt = SegmentTree([i ^ 1 for i in arr])
        ...
        #     l, r = left[i], right[j]
        #     leftfacing = lcnt.query(r + 1, n)
        #     rightfacing = rcnt.query(0, l)

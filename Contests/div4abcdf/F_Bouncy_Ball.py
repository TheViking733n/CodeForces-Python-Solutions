...
def main():
    ...
    for _ in range(TestCases):
        n, m, i1, j1, i2, j2, d = [i for i in input().split()]
        n, m, i1, j1, i2, j2 = int(n), int(m), int(i1)-1, int(j1)-1, int(i2)-1, int(j2)-1
        dir = {'DR': (1, 1), 'DL': (1, -1), 'UR': (-1, 1), 'UL': (-1, -1)}
        ...
        #         j0 = j1 + jdir
        #         bounce = True
        #     if (idir, jdir) in vis[i0][j0]:
        #         f = 1
        #         break
        #     cnt += bounce
        #     vis[i0][j0].add((idir, jdir))

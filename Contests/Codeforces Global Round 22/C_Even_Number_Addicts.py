...
def main():
    ...
    for _ in range(TestCases):
        ...
        # print(["Alice", "Bob"][f(turn, score, one, zero)])



        if zero&1==0 and one&1==0:
            print("Alice" if one%4==0 else "Bob")
            continue
        ...
        if zero&1==0 and one&1:
            print("Bob" if ((one+1)//2)&1 else "Alice")
            continue
        

        
        print("Bob" if one%4 else "Alice")
        ...
        # if zero == 0:
        #     print("Bob" if take&1 else "Alice")
        #     continue

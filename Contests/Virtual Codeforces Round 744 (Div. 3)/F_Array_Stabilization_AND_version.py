...
def nearestZero(cur, arr, ans, n, d):
    par = (cur - d) % n
    if ans[par] != INF:
        ans[cur] = ans[par] + 1
    elif arr[par] == 0:
...
def main():
    ...
    for _ in range(TestCases):
        ...
        # print(ans)
        print(max(ans) if -1 not in ans else -1)
        ...
        # ans = [INF] * n
        # for i in range(n):
        #     if arr[i] == 0 or ans[i] != INF:
        #         continue
        #     nearestZero(i, arr, ans, n, d)
        ...
        #     if arr[st] == 1:
        #         continue
        #     for i in range(st + d, 2 * n + d, d):
        #         cnt += 1
        #         if arr[i % n] == 1:
        #             ans[i % n] = min(ans[i % n], cnt)
        # for i in range(n):
        #     if not arr[i]:
        #         ans[i] = 0
        # # print(arr, d)

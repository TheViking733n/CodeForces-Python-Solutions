...
signed main()
{
    ...
    while (TestCases--)
    {
        ...
        //         if (val == 1 || f == 0) continue;

        //         if (f > 0 && freq[len(val)] < 0) {
        //             freq[len(val)]++;
        //             freq[val]--;
        //             ans++;
        //             left--;
        //             left--;
        //         } else if (f < 0  && freq[len(val)] > 0) {
        //             freq[len(val)]--;
        //             freq[val]++;
        //             ans++;
        //             left--;
        ...
        for (auto &it : m2) {
            if (it.first!=1) ans += abs(it.second);
        }
        ...
        // for (auto it: m2) {
        //     int f = it.second;
        //     if (len(it.first) != it.first) ans += abs(f);
        // }

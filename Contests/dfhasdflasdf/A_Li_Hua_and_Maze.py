...
def main():
    ...
    for _ in range(TestCases):
        ...
        xcorner1 = x1 == 1 or x1 == n
        xcorner2 = x2 == 1 or x2 == n
        ycorner1 = y1 == 1 or y1 == m
        ycorner2 = y2 == 1 or y2 == m

        if (xcorner1 and ycorner1) or (xcorner2 and ycorner2):
            print(2)
        elif xcorner1 or xcorner2 or ycorner1 or ycorner2:
            print(3)
        else:
            print(4)

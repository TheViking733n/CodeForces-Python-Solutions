...
'''
if no zero then print(Draw)
elif palindrome and only one '1' then print(Bob)
elif not palindrome then print(Alice)
elif size even then print(Bob)
elif arr[mid] == '1' print(Bob)
else print(Alice)
'''
...
def main():
    ...
    for _ in range(TestCases):
        ...
        if '0' not in s: print('DRAW')
        elif palin and s.count('1') == 1: print('BOB')
        elif not palin: print('ALICE')
        elif not odd: print('BOB')
        elif s[n >> 1] == '1': print('BOB')
        else: print('ALICE')
